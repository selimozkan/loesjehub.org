...
class HomePageAdmin(admin.ModelAdmin):
  ...
  list_display_links = ['thumb', 'welcome_title',]
  fields = ['img', 'welcome_image', 'welcome_title', 'welcome_description', 'objectives_img', 'objectives_image', 'objectives_title',  'latest_projects_title', 'latest_projects_description', 'impressum', 'privacy_policy', 'disclaimer']
  readonly_fields = ['img', 'objectives_img',]
...
class PartnerAdmin(admin.ModelAdmin):
  ...
  fields = ['img', 'image', 'name', 'short_description', 'long_description', 'linktree']
  readonly_fields = ['img',]
...
class ProjectAdmin(admin.ModelAdmin):
  ...
  fields = ['img', 'image', 'author', 'partners', 'title', 'description', 'article', 'ongoing', 'slug']
  readonly_fields = ['img',]
