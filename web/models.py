...
class PageHeader(models.Model):
    ...
    def bg_thumbnail(self):
        if self.page_image:
            return mark_safe(
                '<img src="%s" style="width:50px;height:50px;" alt="" />'
                % self.page_image.url
            )
        else:
            return "No Image"
    ...
    def bg_image(self):
        if self.page_image:
            return mark_safe(
                '<img src="%s" style="height:150px;" alt="" />' % self.page_image.url
            )
        else:
            return "No Image"
...
class HomePage(models.Model):
    ...
    objectives_image = models.ImageField(
        upload_to="home/",
        null=True,
        blank=True,
        validators=[
    ...
    def img(self):
        if self.welcome_image:
            return mark_safe(
                '<img src="%s" style="height:150px;" alt="" />' % self.welcome_image.url
            )
        else:
            return "No Image"
    ...
    def objectives_img(self):
        if self.objectives_image:
            return mark_safe(
                '<img src="%s" style="height:150px;" alt="" />'
                % self.objectives_image.url
            )
        else:
            return "No Image"
...
class SpecificObjective(models.Model):
    objective = models.ForeignKey(
        Objective, on_delete=models.CASCADE, null=False, blank=False
    )
...
class About(models.Model):
    ...
    def img(self):
        if self.image:
            return mark_safe(
                '<img src="%s" style="height:150px;" alt="" />' % self.image.url
            )
        else:
            return "No Image"
...
class Project(models.Model):
    ...
    def thumb(self):
        if self.image:
            return mark_safe(
                '<img src="%s" style="width:50px;height:50px;" alt="%s" />'
    ...
    def img(self):
        if self.image:
            return mark_safe(
                '<img src="%s" style="height:150px;" alt="%s" />'
                % (self.image.url, self.title)
            )
        else:
            return "No Image"
